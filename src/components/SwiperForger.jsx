...
export default function SwiperForger() {
    ...
    return (
        <div className={`${bgColor} py-16 transition-colors duration-500`}>
            <style>{`
                @import url('https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
                * { font-family: 'Poppins', sans-serif; }
            `}</style>

            <h1 className={`text-3xl font-semibold text-center mx-auto ${textColor}`}>
                Our Latest Creations
            </h1>
            <p className={`text-sm text-center mt-2 max-w-lg mx-auto ${subTextColor}`}>
