...
const NewsletterSection = () => {
  ...
  const cards = [
    {
      title: "ASOS",
      desc: "Подробная информация о ASOS. Здесь может быть текст, который плавно раскрывается.",
    },
    {
      title: "O'SISH",
      desc: "Описание пакета O'SISH. Здесь может быть длинная информация, раскрываемая плавно.",
    },
    {
      title: "TA'SIR",
